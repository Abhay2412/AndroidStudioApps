        ...
        horizontalAlignment = Alignment.CenterHorizontally
            ...
            Row(
                ...
                WeatherDataDisplay(value = data.pressure.roundToInt(), unit = "hpa",
                    icon = ImageVector.vectorResource(id = com.weatherapp.R.drawable.ic_pressure),
                iconTint = Color.White,
                textStyle = TextStyle(color=Color.White)
                )
                WeatherDataDisplay(value = data.humidity.roundToInt(), unit = "%",
                    icon = ImageVector.vectorResource(id = com.weatherapp.R.drawable.ic_drop),
                    iconTint = Color.White,
                    textStyle = TextStyle(color=Color.White)
                )
                WeatherDataDisplay(value = data.windSpeed.roundToInt(), unit = "km/h",
                    icon = ImageVector.vectorResource(id = com.weatherapp.R.drawable.ic_wind),
                    iconTint = Color.White,
                    textStyle = TextStyle(color=Color.White)
                )
            }
